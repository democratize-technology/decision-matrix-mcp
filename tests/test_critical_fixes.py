...
class TestTypeSafety:
    ...
    def test_option_weighted_total_all_none_scores(self):
        ...
        option = Option(name="Test Option")
        criteria = {
            "criterion1": Criterion(name="criterion1", description="Test", weight=2.0)
        }
...
class TestSessionValidationGuards:
    ...
    async def test_all_handlers_have_session_guards(self):
        ...
        from decision_matrix_mcp import (
            add_criterion, evaluate_options, get_decision_matrix, add_option,
            AddCriterionRequest, EvaluateOptionsRequest, 
            GetDecisionMatrixRequest, AddOptionRequest,
        ...
        # Test add_criterion
        result = await add_criterion(AddCriterionRequest(
...
class TestIntegration:
    ...
    async def test_full_workflow_with_fixes(self):
        ...
        from decision_matrix_mcp import (
            ...
            get_decision_matrix, StartDecisionAnalysisRequest,
            AddCriterionRequest, EvaluateOptionsRequest,
            GetDecisionMatrixRequest, get_server_components
        )
        ...
        # Start analysis
        start_result = await start_decision_analysis(StartDecisionAnalysisRequest(
        ...
        # Add criterion
        criterion_result = await add_criterion(AddCriterionRequest(
