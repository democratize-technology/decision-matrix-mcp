...
class TestModelEdgeCases:
    ...
    def test_option_get_score_breakdown_with_missing_criteria(self):
        ...
        score = Score(criterion_name="Missing", option_name="Test", score=8.0, justification="Good")
    ...
    def test_decision_session_get_matrix_with_none_scores(self):
        ...
        session = DecisionSession(session_id="test", created_at=MagicMock(), topic="Test")
...
class TestFormatterMissingLines:
    ...
    def test_formatter_detailed_justifications(self):
        ...
        assert (
            "Very cost effective solution with excellent ROI and low maintenance costs over t..."
            in output
        )
