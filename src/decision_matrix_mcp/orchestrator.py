...
from .models import CriterionThread, Option, ModelBackend
...
class DecisionOrchestrator:
    ...
    async def evaluate_options_across_criteria(
        ...
        logger.info(f"Starting parallel evaluation of {len(options)} options across {len(threads)} criteria")
...
JUSTIFICATION: [your reasoning]"""
    ...
    def _parse_evaluation_response(self, response: str) -> Tuple[Optional[float], str]:
        ...
        try:
            ...
            justification_match = re.search(r'JUSTIFICATION:\s*(.+)', response, re.IGNORECASE | re.DOTALL)
    ...
    async def _call_bedrock(self, thread: CriterionThread) -> str:
        ...
        try:
            ...
            raise Exception("boto3 not available for Bedrock backend")
    ...
    async def _call_ollama(self, thread: CriterionThread) -> str:
        ...
        try:
            ...
            raise Exception("httpx not available for Ollama backend")
        except Exception as e:
